...
<script>
    ...
    document.location = "workshop6_delete.php?username=" + username; // สงรหัสส ่ นค ้าไปให ้ไฟล์ ิ delete.php
    }
</script>
</head>
<body>
<?php
    ...
    echo "<a href='workshop9_edit.php?username=".$row["username"]."'>แก้ไข</a> | ";
