...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2023 at 03:18 PM
...
('thame', '123456', 'manassawin', '111/1', '0984562378', 'manassawin@kmutnb.com', 1);
...
INSERT INTO `product` (`pid`, `pname`, `pdetail`, `price`, `qty_prod`) VALUES
(2, 'Caltrate', 'บำรุงกระดูก เสริมวิตามินดี', 760, 10),
(3, 'Ester-C', 'วิตามินซี 500 mg ไม่กัดกระเพาะ', 500, 20),
(4, 'Glucosamine', 'บำรุงข้อต่อ ป้องกันข้อเสื่อม', 1200, 30);
